  ...
  <Col md={4} className='mb-4'>
    <Card className='h-100 cause-card'>
      <Card.Body className='text-center'>
        ...
        <Card.Title className='mt-3 mb-3 font-weight-bold cause-title'>{title}</Card.Title>
      ...
      <Container className='about-container'>
        ...
        <Row>
          <Col md={6}>
            <p className='work-description'>
              Here, describe the work done by the NGO in this section. You can provide details, achievements, goals,
              or any relevant information about the NGO's activities, social projects, or initiatives.
            </p>
          </Col>
          <Col md={6}>
            <p className='work-description'>
        ...
        <Row xs={1} md={3} className='g-4'>
          {photos.map((photo, index) => (
            <ImageCard key={index} src={photo} alt={`Photo ${index + 1}`} onClick={openModal} />
          ))}
        </Row>
